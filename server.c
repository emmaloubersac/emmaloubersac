...
void broadcastMessage(char *mess) //envoie un mess a tout le monde (client graphique)
{
        int i;
        ...
        if (fsmServer==0)
        {
        	switch (buffer[0])
        	{
                                ...
                                if (nbClients==4)
				{
					...
					sprintf(reply,"D %d %d %d %d %d %d %d %d %d %d %d", deck[0], deck[1], deck[2],tableCartes[0][0],
						tableCartes[0][1],tableCartes[0][2],tableCartes[0][3],tableCartes[0][4],tableCartes[0][5],tableCartes[0][6],
						tableCartes[0][7]);
					...
					// RAJOUTER DU CODE ICI
					sprintf(reply,"D %d %d %d %d %d %d %d %d %d %d %d", deck[3], deck[4], deck[5],tableCartes[1][0],
						tableCartes[1][1],tableCartes[1][2],tableCartes[1][3],tableCartes[1][4],tableCartes[1][5],tableCartes[1][6],
						tableCartes[1][7]);
					...
					// RAJOUTER DU CODE ICI
					sprintf(reply,"D %d %d %d %d %d %d %d %d %d %d %d", deck[6], deck[7], deck[8],tableCartes[2][0],
						tableCartes[2][1],tableCartes[2][2],tableCartes[2][3],tableCartes[2][4],tableCartes[2][5],tableCartes[2][6],
						tableCartes[2][7]);
					...
					// RAJOUTER DU CODE ICI
					sprintf(reply,"D %d %d %d %d %d %d %d %d %d %d %d", deck[9], deck[10], deck[11],tableCartes[3][0],
						tableCartes[3][1],tableCartes[3][2],tableCartes[3][3],tableCartes[3][4],tableCartes[3][5],tableCartes[3][6],
						tableCartes[3][7]);
